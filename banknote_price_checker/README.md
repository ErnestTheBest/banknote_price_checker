...
This tool checks prices for products on veikals.banknote.lv using custom filters and outputs results to separate files.
...
The HTML generation logic is modularized in [`htmlGenerator.js`](./htmlGenerator.js). You can customize the table output by editing this file.
